...
public class TaskController {
    ...
    @Operation(summary = "Create a new task", description = "Requires the ADMIN role.")
    @PostMapping
    ...
    @Operation(summary = "Update an existing task", description = "Requires the ADMIN role.")
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Delete a task", description = "Requires the ADMIN role.")
    @DeleteMapping("/{id}")
