...
@Tag(name = "Projects", description = "Endpoints for managing projects and their nested tasks")
@RestController
...
public class ProjectController {
    ...
    @Operation(summary = "Add a task to a project", description = "Requires ADMIN. The new task is automatically linked to this project.")
