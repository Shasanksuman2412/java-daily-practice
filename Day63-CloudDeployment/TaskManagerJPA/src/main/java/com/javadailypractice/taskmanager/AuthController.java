...
@Tag(name = "Auth", description = "Registration and login - these two endpoints don't require a token")
@RestController
@RequestMapping("/auth")
public class AuthController {
    ...
    @Operation(summary = "Register a new user", description = "Open to everyone. New users always get the USER role.")
    ...
    @Operation(summary = "Log in and receive a JWT", description = "Use the returned token in the Authorize button above for all other endpoints")
    @PostMapping("/login")
