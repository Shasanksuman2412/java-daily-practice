    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Swagger UI and its underlying OpenAPI spec - open so anyone
                // can VIEW the docs without a token; individual endpoints
                // "tried out" from the UI still enforce all the usual rules.
                .requestMatchers("/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**").permitAll() // no token needed to register or log in
